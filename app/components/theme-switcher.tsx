...
export default function ThemeSwitcher() {
  ...
  if (!mounted) {
    // Avoid rendering the toggle during SSR to prevent hydration mismatch
    return <div className="w-8 h-8"></div>;
  }

  return (
    <div className="flex items-center border border-neutral-200 dark:border-neutral-800 rounded-none p-1">
      <button
