      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            >
              Meet the talented writers behind our articles. Our diverse team brings expertise from various fields to deliver high-quality content.
            </motion.p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {authors.map((author, index) => (
              ...
              >
                ...
                <p className="text-neutral-600 dark:text-neutral-400 mb-6 max-w-xs mx-auto">
                ...
                <TransitionLink href={`/author/${author.id}`} className="btn btn-primary">
                  View Articles
                </TransitionLink>
              </motion.div>
            ))}
