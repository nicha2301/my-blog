...
// Định nghĩa interface để tránh lỗi kiểu dữ liệu
...
// API để lấy các bài viết phổ biến nhất
async function getPopularPages() {
  try {
    ...
    // Truy vấn các trang phổ biến nhất trong 7 ngày qua
    ...
    // Log lỗi chi tiết
    console.error('Lỗi khi truy xuất dữ liệu trang phổ biến:', error);
    throw error;
  }
}
